...
# View profiles by a certain skill
...
# This function handles the user's inbox page. It's only accessible if the user is logged in.
@login_required(login_url='login')
def inbox(request):
    profile = request.user.profile
...
# This function is used to view a single message. It's only accessible if the user is logged in.
@login_required(login_url='login')
